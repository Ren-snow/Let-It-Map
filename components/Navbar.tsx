        ...
        <nav className="bg-indigo-900 shadow-md py-4">
            <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
                ...
                <div className="flex items-center space-x-4 text-white">
                    ...
                    <button className="flex items-center justify-center gap-2 cursor-pointer bg-white text-indigo-900 font-bold p-2 rounded-sm transition border border-white hover:bg-indigo-900 hover:text-white" onClick={login}>
                        Sign In
                        <svg
                    ...
                    <button className="bg-white text-indigo-900 font-bold p-2 rounded-sm cursor-pointer transition border border-white hover:bg-indigo-900 hover:text-white" >
                        Sign Out
                    </button>
                </div>
            </div>
